...
class TestCreateJson(unittest.TestCase):
    ...
    def test_create_json(self, mock_load_workbook):
        ...
        mock_rows = [
            ("host-1_uu-1", "srv-001", "acc.abb", "172.14.13.12", "00:26:57:00:1f:02", "172.14.13.254", "host1", "10.40.19.5"),
            ("host-2_uu-2", "srv-002", "acc.abb", "172.14.13.13", "00:26:57:00:1f:03", "172.14.13.254", "host2", "10.40.19.5"),
        ]
        ...
        self.assertEqual(host_1_data["hostname"],"host1")
        self.assertEqual(host_1_data["name_servers"],"172.14.77.19")
        ...
        self.assertEqual(host_2_data["hostname"], "host2")
        self.assertEqual(host_2_data["name_servers"],"172.14.77.19")
